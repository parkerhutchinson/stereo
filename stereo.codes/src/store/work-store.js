export const projectList = [
  {
    ...
    date: '2018',
    title: 'Draftboard',
    stack: ['React', 'Django', 'CSS3'],
    position: 'Full Stack Javascript',
    image: './images/work/draftboard-mobile.jpg',
    link: 'https://draftboard.com',
    copy: '<p>Draftboard is the carefully crafted online competitive fantasy sports web application. Built on a Django backbone with a React client. This web app utilizes the latest in web technology stack to delivery a cutting edge look into fantasy sports betting. My role as full stack javascript developer at draft board was to work closely with the existing team to update the application to industry standards such as mobile first css architecture and ES6 class based components. </p>',
  },
  {
    id: 1,
    date: '2017',
    title: 'Lycoming',
    stack: ['Drupal 8', 'CSS3', 'Vanilla JS'],
    position: 'Full Stack',
    link: 'http://www.lycoming.com',
    image: './images/work/lycoming-mobile.jpg',
    copy: '<p>The worlds largest general aviation engine manufacturer and the only FAA certified aerobatic engine. Lycoming is household name in the aviation world. Lycoming.com is a portal not only for marketing; its a account driven resource for distributors and suppliers. Built  in the Drupal content management system on completely custom theme where I worked as back-end and front-end developer. </p>',
  },
  {
    id: 2,
    date: '2017',
